    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-secondary/20 to-background p-4">
      <div className="w-full max-w-md animate-fade-up">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-muted-foreground text-sm">AI Lifestyle & Rental Discovery</p>
        </div>
                      ...
                      <div className="flex items-center space-x-3 p-3 rounded-lg border border-border hover:border-primary/50 transition-colors cursor-pointer">
                        ...
                        <Label htmlFor="role-user" className="flex items-center gap-2 cursor-pointer flex-1">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-muted-foreground">Track lifestyle, nutrition & find homes</p>
                          </div>
                        </Label>
                      </div>
                      <div className="flex items-center space-x-3 p-3 rounded-lg border border-border hover:border-primary/50 transition-colors cursor-pointer">
                        <RadioGroupItem value="house_owner" id="role-owner" />
                        <Label htmlFor="role-owner" className="flex items-center gap-2 cursor-pointer flex-1">
                          <Home className="h-4 w-4 text-primary" />
                          <div>
                            <p className="font-medium">House Owner</p>
                            <p className="text-xs text-muted-foreground">List your properties for rent</p>
                          </div>
                        </Label>
                      </div>
                    </RadioGroup>
